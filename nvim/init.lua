...
-- Define key mappings for buffer navigation and deletion
...
vim.api.nvim_set_keymap('n', 'gd', ':bdelete<CR>', { noremap = true, silent = true })
...
-- remember the last place (cursor position) when reopening a file
